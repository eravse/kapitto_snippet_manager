    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] dark:bg-[#0f172a]">
          <div className="animate-pulse flex flex-col items-center">
            <div className="h-12 w-12 bg-blue-500 rounded-xl mb-4"></div>
          ...
          <div className="mx-auto">
            ...
            <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2 text-sm font-medium bg-white dark:bg-slate-800 p-1 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
                <button className="px-4 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">Giriş</button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5 mb-10">
              {stats.map((stat) => (
                  <div
                      key={stat.label}
                      className="group bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
              {/* Aktivite Grafiği */}
              <div className="lg:col-span-8 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-8 shadow-sm">
              ...
              {/* Popüler Kategoriler */}
              <div className="lg:col-span-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-8 shadow-sm">
                <h2 className="text-xl font-bold mb-6 text-slate-900 dark:text-white">Kategoriler</h2>
                <div className="space-y-4">
                  {analytics?.topCategories.slice(0, 6).map((category: any, idx) => (
                      <div key={category.id} className="group flex items-center justify-between p-3 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors border border-transparent hover:border-slate-100 dark:hover:border-slate-700">
